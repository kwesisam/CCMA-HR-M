...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"fc802c88-50cd-4bd4-8ab9-cc187b9bb117\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [23 x i8] c"com.companyname.hrm_pt\00", align 16
...
@__DSOCacheEntry_name.51 = internal constant [50 x i8] c"libaot-SQLitePCLRaw.provider.dynamic_cdecl.dll.so\00", align 16
...
@__DSOCacheEntry_name.54 = internal constant [21 x i8] c"libaot-HRM_PT.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [510 x %struct.DSOCacheEntry] [
	...
	; 69
	%struct.DSOCacheEntry {
		i64 2542931250092766026, ; hash 0x234a4e7fba04f34a, from name: HRM_PT
		i8 0, ; ignore
	...
	; 96
	%struct.DSOCacheEntry {
		i64 3417996111177864823, ; hash 0x2f6f295a926c5677, from name: libaot-HRM_PT.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 133
	%struct.DSOCacheEntry {
		i64 5047586231847690462, ; hash 0x460ca0ef426f20de, from name: aot-HRM_PT
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 265
	%struct.DSOCacheEntry {
		i64 9857381936362256696, ; hash 0x88cc74a4fc397938, from name: aot-HRM_PT.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 288
	%struct.DSOCacheEntry {
		i64 10728734113508858810, ; hash 0x94e41ed53d4f9bba, from name: HRM_PT.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 339
	%struct.DSOCacheEntry {
		i64 12281795234495008941, ; hash 0xaa71b3b1ac2910ad, from name: libaot-HRM_PT
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
